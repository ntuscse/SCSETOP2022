...
const Welcome = () => {
  ...
  return (
    <div class="welcomeMain"
      ...
      <svg class="wave" width="100%" height="auto" viewBox="0 0 1900 254" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 101.961C0 101.961 581.71 -71.5749 946.049 34.1434C1310.39 139.862 1900 44.1168 1900 44.1168V254H0V101.961Z" fill="#21333E"/>
      </svg>
