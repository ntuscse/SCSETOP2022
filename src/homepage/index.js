...
const HomePage = () => {
  ...
  const AS_randomValsDelayMobile = [
    getRandomValue(8, 2),
    getRandomValue(8, 2),
    getRandomValue(8, 2),
    getRandomValue(8, 2),
  ...
  const AS_randomValsDurationMobile = [
    getRandomValue(25, 10),
    getRandomValue(25, 10),
    getRandomValue(25, 10),
    getRandomValue(25, 10),
  ];
  ...
  return (
    <>
      ...
      <div class="container" id="gradient">
        ...
        <div id="register" class="bg-div">
          <div class="logo-div">
            <Logo></Logo>
            <div class="button">
              <a
                href="https://wis.ntu.edu.sg/pls/webexe88/REGISTER_NTU.REGISTER?EVENT_ID=OA22052709333861"
                target="_blank"
              >
                <img class="register" src={RegisterBtn}></img>
              </a>
